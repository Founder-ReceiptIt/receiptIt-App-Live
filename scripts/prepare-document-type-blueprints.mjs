...
const fixtureNeutrality = ' Classification is based on document form and content. Incidental training, sample, demonstration, test, or placeholder markings do not by themselves change a clearly structured retail receipt into a non-purchase document.';
...
if (!pdfSystem.content.includes('Incidental training, sample, demonstration')) pdfSystem.content += fixtureNeutrality;
