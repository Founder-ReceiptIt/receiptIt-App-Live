...
try{
 ...
 if(format!=='stills'){
  await story.evaluate(e=>{e.removeAttribute('hide-action');e.removeAttribute('mode');e.seek(8);});const height=Math.ceil((await story.boundingBox()).height/2)*2;
